...
class ReactorProcessEngineTest extends EngineTestSupport {
    ...
    @Test
    void should_get_process_id_after_start_process() {
        ProcessDefinition processDefinition = ProcessDefinition.builder()
            .withVersion(1)
            .withName("test")
            .withNodes(
    ...
    @Test
    void should_throw_exception_when_continue_executing_not_exists_node() throws InterruptedException {
        ProcessDefinition processDefinition = ProcessDefinition.builder()
            .withVersion(1)
            .withName("test")
            .withNodes(
    ...
    @Test
    void should_throw_exception_when_continue_executing_not_exsists_process() throws InterruptedException {
        ProcessDefinition processDefinition = ProcessDefinition.builder()
            .withVersion(1)
            .withName("test")
            .withNodes(
    ...
    @Test
    void should_throw_exception_when_process_definition_name_was_null() {
        try {
    ...
    @Test
    void should_throw_exception_when_process_definition_was_not_exists() {
        try {
            Mockito.when(repository.findProcessDefinition("test", 1))
