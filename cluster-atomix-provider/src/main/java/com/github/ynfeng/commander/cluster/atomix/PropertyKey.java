...
public final class PropertyKey {
    ...
    public static final String CLUSTER_DISCOVERY_BROADCAST_INTERVAL_SECONDS = "cluster.bootstrapDiscoveryBroadcastIntervalSeconds";
    public static final String CLUSTER_MEMBERSHIP_FAILURE_TIME_OUT_SECONDS = "cluster.membership.failureTimeOutSeconds";
    public static final String CLUSTER_MEMBERSHIP_GOSSIP_INTERVAL_MS = "cluster.membership.gossipIntervalMs";
